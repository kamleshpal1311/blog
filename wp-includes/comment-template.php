...
function comment_form( $args = array(), $post_id = null ) {
	...
	/*$fields   =  array(
		'author' => '<p class="comment-form-author">' . '<label for="author">' . __( 'Name' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
		            '<input id="author" name="author" class="form-control comment_input" placeholder="Type your name here..." type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" maxlength="245"' . $aria_req . $html_req . ' /></p>',
		'email'  => '<p class="comment-form-email"><label for="email">' . __( 'Email' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
		            '<input id="email" class="form-control comment_input" placeholder="Type your email here..." name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" maxlength="100" aria-describedby="email-notes"' . $aria_req . $html_req  . ' /></p>',
		'url'    => '<p class="comment-form-url"><label for="url">' . __( 'Website' ) . '</label> ' .
		            '<input id="url" class="form-control comment_input" placeholder="Type your website url here..." name="url" ' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" maxlength="200" /></p>',
	);*/
	$fields   =  array(
		'author' => '<p class="comment-form-author">'.
		            '<div class="form-group"><input id="author" name="author" class="form-control comment_input" placeholder="Type your name here..." type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" maxlength="245"' . $aria_req . $html_req . ' /></div></p>',
		'email'  => '<p class="comment-form-email">'.
		            '<div class="form-group"><input id="email" class="form-control comment_input" placeholder="Type your email here..." name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" maxlength="100" aria-describedby="email-notes"' . $aria_req . $html_req  . ' /></div></p>',
		'url'    => '<p class="comment-form-url">'.
		            '<div class="form-group"><input id="url" class="form-control comment_input" placeholder="Type your website url here..." name="url" ' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" maxlength="200" /></div></p>',
	);
	...
	$defaults = array(
		'fields'               => $fields,
		// 'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <textarea id="comment" class="form-control comment_textarea" name="comment" cols="45" rows="5" maxlength="65525" aria-required="true" required="required" placeholder="Type your comment here..."></textarea></p>',
		'comment_field'        => '<p class="comment-form-comment">'. '<div class="comment_lable">Comments</div><div class="form-group"><textarea id="comment" class="form-control comment_textarea" name="comment" cols="45" rows="5" maxlength="65525" aria-required="true" required="required" placeholder="Type your comment here..."></textarea></div></p>',
		...
		'class_submit'         => 'submit btn btn-default pull-right comment_submit',
		'name_submit'          => 'submit',
