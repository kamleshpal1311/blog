...
class SS_Public {
	...
	public function social_sharing( $atts=array() ) {
		...
		ob_start();
		?>
		<ul class="nav navbar-nav text-center post_sharing <?php echo $sssocial_sharing;?>">
	        	...
	        	switch($o) {
	        		case 'f':
	        			...
	        			?><li><a href="#">Share</a></li>
	        				<li><a <?php echo $loadjs;?> rel="external nofollow" href="http://www.facebook.com/sharer/sharer.php?u=<?php echo $url; ?>" target="_blank" ><i class="fa fa-facebook"></i></a></li><?php
	        			}
	        		break;
	        		case 't':
	        			if(in_array('twitter', $social_options)){
	        			?><li><a <?php echo $loadjs;?> rel="external nofollow" href="http://twitter.com/intent/tweet/?text=<?php echo $title; ?>&url=<?php echo $url; ?><?php if(!empty($twitter_username)) {  echo '&via=' . $twitter_username; } ?>" target="_blank"><i class="fa fa-twitter"></i></a></li><?php
	        			}
	        		break;
	        		case 'g':
	        			if(in_array('googleplus', $social_options)){
	        			?><li><a <?php echo $loadjs;?> rel="external nofollow" href="https://plus.google.com/share?url=<?php echo $url; ?>" target="_blank" ><i class="fa fa-google-plus"></i></a></li><?php
	        			}
	        		break;
					case 'l':
	        		...
	        		case 'p':
	        			if(in_array('pinterest', $social_options)){
	        				?><li><a <?php echo $loadjs;?> rel="external nofollow" href="http://pinterest.com/pin/create/button/?url=<?php echo $url;?>&media=<?php echo $social_image;?>&description=<?php echo $title;?>" target="_blank" ><i class="fa fa-pinterest"></i></a></li><?php
	        			}
					break;
                    case 'x':
